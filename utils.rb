...
def usage(msg)
  ...
  msg.reply 'list [stories|tasks|defects] (<state>) (<email>) - list stuff assigned to you'
  msg.reply '  (<state> can be one of [backlog|defined|in-progress|completed|accepted])'
  msg.reply '  (<email> will instead list stuff assigned to the specified user)'
